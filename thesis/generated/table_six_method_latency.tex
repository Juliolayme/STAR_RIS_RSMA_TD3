% Generated from results/six_method_v1/tables/TABLE_SIX_METHOD_CPU_LATENCY.csv
% All measurements are single-thread CPU measurements on one collector runner.

\begin{landscape}
\begin{longtable}{r l r r r r r}
  \caption{Độ trễ ra quyết định của sáu phương pháp trên cùng một CPU runner.}
  ...
  \endhead
  \midrule
  \multicolumn{7}{r}{Còn tiếp ở trang sau}\\
  \endfoot
  \bottomrule
  \endlastfoot
...
\noindent\textit{Lưu ý:} AnalyticalRIS có độ trễ nhỏ nhất nhưng không đáp ứng QoS trong thí nghiệm. AO-SCA đạt tổng tốc độ cao nhất nhưng cần từ khoảng 216 đến 1.039 ms cho mỗi quyết định. TD3 yêu cầu khoảng 0,25--0,34 ms và nhanh hơn AO-SCA khoảng 880--3.038 lần trong thiết lập CPU đơn luồng đã công bố.