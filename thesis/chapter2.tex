...
\ThesisFigure{figures/chapter2_conceptual_foundation.pdf}{Liên kết lý thuyết giữa RSMA, STAR--RIS và TD3}{fig:ch2-foundation}
\figuresource{Tác giả đề xuất (2026)}

Hình~\ref{fig:ch2-foundation} liên kết ba tầng lý thuyết. Tầng tín hiệu RSMA chuyển công suất và tỷ lệ common rate thành tốc độ người dùng; tầng STAR--RIS chuyển beta và pha thành kênh hiệu dụng; tầng TD3 ánh xạ CSI sang toàn bộ biến điều khiển và nhận reward từ tầng vật lý. Mũi tên hồi tiếp từ QoS violation về reward minh họa lý do cần penalty và dual controller. Hình cũng chỉ rõ action decoder nằm giữa actor và mô hình vật lý, bảo đảm mạng nơ-ron không trực tiếp phát sinh biến bất khả thi.
