...
\ThesisFigure{figures/chapter5_quality_latency_tradeoff.pdf}{Không gian đánh đổi chất lượng--QoS--độ trễ của các phương pháp}{fig:ch5-tradeoff}
\figuresource{Tác giả đề xuất dựa trên kết quả đã kiểm toán (2026)}

Hình~\ref{fig:ch5-tradeoff} nên là sơ đồ định tính ba trục hoặc ma trận hai chiều có mã hóa QoS. Trục ngang là latency tăng dần, trục dọc là sum-rate tăng dần. AnalyticalRIS nằm góc trái thấp với ký hiệu QoS không đạt; AO--Grid nằm giữa thấp; TD3 nằm vùng trái--giữa với QoS cao; AO--SCA nằm phía phải cao. Không nên vẽ các tọa độ tuyệt đối khi chưa nhập raw latency và sum-rate theo từng $N$; thay vào đó ghi các tỷ lệ range cạnh mũi tên. Hình liên kết trực tiếp với kết luận trade-off của chương.
