...
\vspace{1.5cm}
\IfFileExists{figures/logo_uth.png}{%
...
\clearpage
\chapter*{LỜI CẢM ƠN}
Tôi xin bày tỏ lòng biết ơn sâu sắc đến \SupervisorOne\ và \SupervisorTwo\ đã định hướng khoa học, góp ý về mô hình truyền thông, thuật toán học tăng cường sâu và phương pháp đánh giá thực nghiệm trong suốt quá trình thực hiện đề tài. Những yêu cầu nghiêm ngặt về tính tái lập, cách diễn giải thận trọng và sự nhất quán giữa công thức với phần mềm triển khai là nền tảng giúp luận văn được hoàn thiện.
...
LayerNorm & Layer Normalization -- chuẩn hóa theo lớp\\
