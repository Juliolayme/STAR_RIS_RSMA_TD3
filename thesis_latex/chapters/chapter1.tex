...
Ở panel OMA, mỗi UE chiếm một khối tài nguyên riêng nên không có nhiễu liên người dùng,
nhưng mỗi UE chỉ dùng được $1/K$ tài nguyên. Panel SDMA cho thấy BS dùng véc-tơ tiền mã
hóa để tạo búp sóng riêng cho từng UE; điều này đòi hỏi nhiều anten, nên hệ SISO của luận
văn với một anten duy nhất không tạo được phân tách không gian. Panel NOMA mô tả các UE
...
Panel RSMA cho thấy thông điệp mỗi UE được tách thành phần chung và phần riêng; mọi UE
...
Hình~\ref{fig:ch1-ris-star} đối chiếu hai loại bề mặt. Ở panel bên trái, mỗi phần tử RIS
chỉ điều chỉnh pha của tín hiệu phản xạ, nên toàn bộ năng lượng quay về nửa không gian
chứa BS và các UE nằm sau bề mặt không nhận được đường ghép tầng. Ở panel bên phải, mỗi
...
Panel AnalyticalRIS cho thấy trước khi căn pha, các thành phần ghép tầng đến từ những
...
Panel AO--SCA mô tả hai cơ chế cập nhật. Với khối đơn hình, bộ giải chuyển một lượng
...
Panel AO--Grid dùng cùng đường cong mục tiêu để tiện so sánh. Lưới công suất có chứa mức
