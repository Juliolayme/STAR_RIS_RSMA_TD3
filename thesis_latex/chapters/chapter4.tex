...
\begin{figure}[htbp]
\centering
\resizebox{\textwidth}{!}{\input{figures/fig_ch4_duong_cong_xac_thuc}}
...
\input{figures/bang_ch4_do_lech_chuan}
...
\input{figures/bang_ch4_tong_toc_do}
...
\begin{figure}[htbp]
\centering
\resizebox{0.95\textwidth}{!}{\input{figures/fig_ch4_tong_toc_do}}
...
\begin{figure}[htbp]
\centering
\resizebox{0.95\textwidth}{!}{\input{figures/fig_ch4_qos}}
...
\input{figures/bang_ch4_do_tre}

\begin{figure}[htbp]
\centering
\resizebox{0.95\textwidth}{!}{\input{figures/fig_ch4_do_tre}}
...
\begin{figure}[htbp]
\centering
\resizebox{0.95\textwidth}{!}{\input{figures/fig_ch4_danh_doi}}
...
Tuy nhiên, kết quả hiện tại chưa phải một phân tích tách thành phần đầy đủ. Các phép thử
loại bỏ có sẵn gồm không dùng RIS, RIS cố định, RIS ngẫu nhiên và chia công suất đều; chúng
...
luyện ngoại tuyến. Trong các thiết bị có tài nguyên tính toán rất hạn chế và chỉ cần một
