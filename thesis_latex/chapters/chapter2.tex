...
\begin{figure}[htbp]
\centering
\resizebox{0.95\textwidth}{!}{\input{figures/fig_ch2_mo_hinh_he_thong}}
...
hợp duy nhất. Không có véc-tơ beamforming riêng cho từng UE. Vì vậy, ở một UE bất kỳ, tất
...
\begin{figure}[htbp]
\centering
\resizebox{\textwidth}{!}{\input{figures/fig_ch2_kien_truc_thu_phat}}
...
Hình~\ref{fig:ch2-tran-toc-do} minh họa hai kết quả trên. Panel bên trái vẽ $R_{p,k}$
...
decibel và không vượt được trần của mình dù kênh có tốt đến đâu. Panel bên phải vẽ giá
trị tiệm cận $\log_2\big(M/(M-1)\big)$ theo số luồng riêng hoạt động, cho thấy trần này
giảm rất nhanh khi $M$ tăng.

\begin{figure}[htbp]
\centering
\resizebox{\textwidth}{!}{\input{figures/fig_ch2_tran_toc_do}}
...
Phân tích trên không phải chứng minh rằng nghiệm tối ưu toàn cục luôn chính xác one-hot.
...
Hình~\ref{fig:ch2-can-pha} minh họa hiệu ứng này. Ở panel bên trái, các thành phần ghép
tầng có pha lệch nhau nên khi cộng tiếp nối, chúng tạo thành một đường gấp khúc gần khép
kín và véc-tơ tổng rất ngắn. Ở panel bên phải, sau khi mỗi phần tử được xoay về pha tham
...
\begin{figure}[htbp]
\centering
\resizebox{0.9\textwidth}{!}{\input{figures/fig_ch2_can_pha}}
...
máy, đây là cách đưa thiên kiến quy nạp vào chính không gian hành động. Về mặt vật lý, nó
