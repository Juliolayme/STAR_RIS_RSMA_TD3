% =====================================================================
%  Hinh 1.1 (ve lai): So sanh truc giac OMA / SDMA / NOMA / RSMA
%  Bien dich:  xelatex hinh11.tex
% =====================================================================
\documentclass[11pt]{article}
\usepackage[margin=1.4cm,paperwidth=19cm,paperheight=26cm]{geometry}
\usepackage{fontspec}
\setmainfont{Liberation Serif}   % Overleaf: doi thanh "Times New Roman"
\usepackage{amsmath}
\usepackage{tikz}
\usetikzlibrary{positioning,fit,arrows.meta,calc,decorations.pathreplacing,shapes.geometric}
\pagestyle{empty}
...
\tikzset{
  ...
  ue/.style   ={draw,circle,fill=blue!15,inner sep=0pt,minimum size=0.42cm,font=\tiny,line width=0.4pt},
}
...
\vspace{3mm}
{\footnotesize Hình 1.1: So sánh trực giác của OMA, SDMA, NOMA và RSMA với $K=4$ người dùng\\
\textit{Nguồn: Tác giả xây dựng dựa trên [1], [2], [5] (2026)}}
